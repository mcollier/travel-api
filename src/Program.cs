...
var flights = new List<FlightReservation>
{
...
var hotels = new List<HotelReservation>
{
...
app.MapPost("/api/reservation/flight", (FlightReservation flight) =>
{
    ...
    return Results.Created($"/api/reservation/flight/{id}", new FlightReservation(id, flight.Name, flight.From, flight.To, flight.Departure, flight.Arrival));
});
